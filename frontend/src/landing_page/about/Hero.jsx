...
function Hero() {
    return (
        <div className='container'>
            ...
            <div className='row p-5 mt-5 mb-5 border-top text-muted fs-7 ' style={{ lineHeight: "1.9" }}>
                ...
                <div className='col-6 p-5'>
                    ...
                    <p>   And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is <a href='/' style={{ textDecoration: "None" }}>saying about us</a> or learn more about our business and product philosophies.</p>
                </div>
            </div>
